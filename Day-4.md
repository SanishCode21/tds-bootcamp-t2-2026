...
--- Before Day-4 ---
I knew basic HTML and how to use the browser and DevTools..
...
POST: send data to create something (like form submit).
...
Bootcamps workshops was great learning experience. It was much practicals.
